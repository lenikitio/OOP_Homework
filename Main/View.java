...
public class View {
    ...
    public static void view() {
        ...
        System.out.print("Good side");
        // for (int i = 0; i < l[0]-9; i++)
        System.out.print(" ".repeat(l - 9));
        System.out.println(":\tEvil side");
        for (int i = 1; i < 11; i++) {
            System.out.print(getChar(1, i));
        }
        System.out.print("| ");
        System.out.print(Main.heroesGood.get(0));
        tabSetter(Main.heroesGood.get(0).toString().length(), l);
        System.out.println(Main.heroesEvil.get(0));
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("| ");
            System.out.print(Main.heroesGood.get(i - 1));
            tabSetter(Main.heroesGood.get(i - 1).toString().length(), l);
            System.out.println(Main.heroesEvil.get(i - 1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("| ");
        System.out.print(Main.heroesGood.get(9));
        tabSetter(Main.heroesGood.get(9).toString().length(), l);
        System.out.println(Main.heroesEvil.get(9));
